 ...
 * @author macbookair
 */
@WebServlet(name = "GeneraCupon3", urlPatterns = {"/GeneraCupon3"})
public class GeneraCupon3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect("difusor/difusor_cupones.jsp?message=" + URLEncoder.encode("1", "UTF-8"));
        } finally {
            out.close();
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GeneraCupon3.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
