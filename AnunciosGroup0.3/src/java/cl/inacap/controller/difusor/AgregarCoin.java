 ...
 * @author macbookair
 */
@WebServlet(name = "AgregarCoin", urlPatterns = {"/AgregarCoin"})
public class AgregarCoin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AgregarCoin</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AgregarCoin at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
       ...
       // processRequest(request, response);
        try {
            ...
            if (respuesta = true){
                ...
                difusoranuncios.quitarsharecoins(request.getParameter("in_codigo_anuncios"));
            };
