 ...
 * @author macbookair
 */
@WebServlet(name = "GenerarCupon", urlPatterns = {"/GenerarCupon"})
public class GenerarCupon extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            cupon.setNombre_u_difusor(request.getParameter("nombre_difusor"));
            System.out.println(request.getParameter("nombre_difusor"));
            cupon.setCodigo_anuncio(request.getParameter("codigo_anuncio"));
            System.out.println(request.getParameter("codigo_anuncio"));
            cupon.setDescuento_obtenido(request.getParameter("in_descuento_obtenido"));
